...
function ufandshands_getMetaBoxes() {
    ...
    $metaBoxes[] = array(
		    ...
		    'title' => 'Sidebar Text Box 1', // the title of the meta box
		    'page' => 'page', // display this meta box on post editing screens
		    'context' => 'normal',
		    'priority' => 'low', 
		    'fields' => array( // all of the options inside of our meta box
			array(
			  'name' => 'Override Global Text Box 1',
			  'desc' => '',
    ...
    $metaBoxes[] = array(
		    ...
		    'title' => 'Sidebar Text Box 2', // the title of the meta box
		    'page' => 'page', // display this meta box on post editing screens
		    'context' => 'normal',
		    'priority' => 'low', 
		    'fields' => array( // all of the options inside of our meta box
			array(
			  'name' => 'Override Global Text Box 2',
			  'desc' => '',

...
function ufandshands_footer_common_scripts() {
	if (!is_admin()) {
		wp_enqueue_script('cycle',              get_template_directory_uri() . '/library/js/jquery.cycle.min.js', array('jquery'), false, true);
		wp_enqueue_script('autoclear',          get_template_directory_uri() . '/library/js/autoclear.js', false, false, true);
		...
		wp_enqueue_script('pretty-photo',       get_template_directory_uri() . '/library/js/jquery.prettyPhoto.js', array('jquery'), false, true);
...
//Allows us to add an async tag to scripts that we want to load asynchonously

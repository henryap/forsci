...
<div class="ribbon hide-for-large" id="ribbon-responsive-top">
  <div id="responsive-top" class="container">
	<a href="#" id="responsive-nav-toggle" class="hide-for-large" ><img src="<?php bloginfo('template_url'); ?>/images/sb_btn.png" alt="Menu"/></a>
	<?php if (!$disabled_global_elements) : ?><a href="https://ufhealth.org" id="responsive-home"><img src="<?php bloginfo('template_url'); ?>/images/ufhealth-badge-responsive.png" alt="UF Health Home" /></a> <!-- ufhealth-badge.png --><?php endif ?>
	<!-- utility-banner-small-screen.png -->
	<a id="responsive-search-toggle" href="#" class="hide-for-large" ><img src="<?php bloginfo('template_url'); ?>/images/search-button-responsive.png" alt="Menu"/></a>
